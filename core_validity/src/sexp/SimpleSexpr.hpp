...
constexpr string_view KEY_WORD_DEFINE{"def"};
...
constexpr array<string_view ,8> KEY_WORDS{KEY_WORD_ADD,KEY_WORD_DIVID, KEY_WORD_COMPARE, 
  KEY_WORD_DEFINE, KEY_WORD_ASSIGN, KEY_WORD_IF,KEY_WORD_WHILE, KEY_WORD_BLOCK};
